	...
	public :: time_const_p
	contains
	!subroutine time_const (deriv,source_type,pulse_type,t,t0,cur,tmp)
	!implicit none
	...
	!!        tmp = deltafunc(1,t,t0) * cur
	!!    else
	!!        tmp = deltafunc(2,t,t0) * cur
	!!    end if
	!end if
	!end subroutine time_const
